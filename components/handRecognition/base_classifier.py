...
class BaseClassifier:
    ...
    def get_bytes(self, timestamp, writer_data_hand, engaged, frame_pieces, gestures, stream_id, probs, feature, blind):
        self.probs = [0 for i in range(len(gestures))]


        max_index = self._process(feature, writer_data_hand, engaged, frame_pieces, probs, gestures, blind)
