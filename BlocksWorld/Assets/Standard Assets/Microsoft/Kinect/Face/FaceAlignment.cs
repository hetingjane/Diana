...
namespace Windows.Kinect.Face
{
...

    {
        ...
        [RootSystem.Runtime.InteropServices.DllImport("KinectFaceUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern int Microsoft_Kinect_Face_FaceAlignment_get_AnimationUnits(RootSystem.IntPtr pNative, [RootSystem.Runtime.InteropServices.Out] Windows.Kinect.Face.FaceShapeAnimations[] outKeys, float[] outValues, int outCollectionSize);
        [RootSystem.Runtime.InteropServices.DllImport("KinectFaceUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern int Microsoft_Kinect_Face_FaceAlignment_get_AnimationUnits_Length(RootSystem.IntPtr pNative);
        public  RootSystem.Collections.Generic.Dictionary<Windows.Kinect.Face.FaceShapeAnimations, float> AnimationUnits
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
                ...
                var outKeys = new Windows.Kinect.Face.FaceShapeAnimations[outCollectionSize];
                var outValues = new float[outCollectionSize];
                var managedDictionary = new RootSystem.Collections.Generic.Dictionary<Windows.Kinect.Face.FaceShapeAnimations, float>();
        ...
        public  Windows.Kinect.Face.RectI FaceBoundingBox
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
        ...
        [RootSystem.Runtime.InteropServices.DllImport("KinectFaceUnityAddin", CallingConvention=RootSystem.Runtime.InteropServices.CallingConvention.Cdecl, SetLastError=true)]
        private static extern Windows.Kinect.Face.FaceAlignmentQuality Microsoft_Kinect_Face_FaceAlignment_get_Quality(RootSystem.IntPtr pNative);
        public  Windows.Kinect.Face.FaceAlignmentQuality Quality
        {
            get
            {
                if (_pNative == RootSystem.IntPtr.Zero)
