...
namespace Perception.Kinect
{
    public class KinectSensor
    {
        ...
        private void InitializeMultiSourceFrameReader(Windows.Kinect.KinectSensor sensor)
        {
            if (sensor == null)
        ...
        private void OnMultiSourceFrameArrived(object sender, Windows.Kinect.MultiSourceFrameArrivedEventArgs e)
        {
        ...
        private void InitializeAudioFrameReader(Windows.Kinect.KinectSensor sensor)
        {
            if (sensor == null)
                throw new ArgumentNullException("Sensor is null");
        ...
        private void OnAudioFrameArrived(object sender, Windows.Kinect.AudioBeamFrameArrivedEventArgs e)
        {
            IList<Windows.Kinect.AudioBeamFrame> audioBeamFrameList = null;
            ...
            {
                audioBeamFrameList?.Clear();
            }
        }
        

        private void InitializeFaceFrameReader(Windows.Kinect.KinectSensor sensor)
        {
            if (sensor == null)
                throw new ArgumentNullException("Sensor is null");
