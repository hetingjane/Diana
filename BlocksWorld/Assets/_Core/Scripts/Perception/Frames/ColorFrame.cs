...
namespace Perception.Frames
{
    public class ColorFrame : Frame
    {
        ...
        private Windows.Kinect.ColorFrame underlyingColorFrame = null;

        protected Windows.Kinect.ColorFrame UnderlyingColorFrame
        {
           get { return underlyingColorFrame; }
        }

        protected Bitmap colorDataBitmap = null;
        public byte[] colorData = null; // TODO: Ask if this is acceptable or try to add read only functionality
